...
export default function AdminUsers() {
  ...
  return (
    <div className="animate-fade-in">
      ...
      <p className="mt-1 text-muted-foreground">{users.length} usuário(s) registrado(s).</p>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-card">
              ...
              <th className="px-4 py-3 text-left font-medium text-muted-foreground">Verificado</th>
